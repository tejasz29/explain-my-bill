...
export function UploadZone({ disabled, onSelectFile }: UploadZoneProps) {
        ...
        <div className="max-w-2xl space-y-5">
          ...
          <div>
            ...
            <p className="mt-4 max-w-xl text-base leading-7 text-stone-700 md:text-lg">
              We&apos;ll extract the charges, explain each line item in plain English, and call out
              fees that look suspicious.
            </p>
          </div>
